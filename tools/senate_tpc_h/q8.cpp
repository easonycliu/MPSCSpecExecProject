...
#define TEN Integer(width, 10, PUBLIC)
	...
	void create_1_3(
		std::size_t problem_size, const std::vector<Integer>& input_data_1, const std::vector<Integer>& input_data_2,
		std::vector<orow_13>& output_data
	) {
	...
	template <std::size_t width>
	void create_1_2_3(
		std::size_t problem_size, const std::vector<orow_13>& input_data_1, const std::vector<Integer>& input_data_2,
		std::vector<orow_123>& output_data
	) {
		int input_length_1 = problem_size;
		int input_length_2 = problem_size;
	...
	void create_4_5(
		std::size_t problem_size, const std::vector<Integer>& input_data_1, const std::vector<Integer>& input_data_2,
		std::vector<orow_45>& output_data
	) {
		int input_length_1 = problem_size;
		int input_length_2 = problem_size;
	...
	void create_6_7(
		std::size_t problem_size, const std::vector<Integer>& input_data_1, const std::vector<Integer>& input_data_2,
		std::vector<orow_67>& output_data
	) {
	...
	template <std::size_t width>
	void create_4_5_6_7(
		std::size_t problem_size, const std::vector<orow_45>& input_data_1, const std::vector<orow_67>& input_data_2,
		std::vector<orow_4567>& output_data
	) {
		int input_length_1 = problem_size;
		int input_length_2 = problem_size;
	...
	void create_1_2_3_4_5_6_7(
		std::size_t problem_size, const std::vector<orow_123>& input_data_1, const std::vector<orow_4567>& input_data_2,
		std::vector<orow_1234567>& output_data
	) {
		std::size_t input_length_1 = problem_size;
		std::size_t input_length_2 = problem_size;
	...
	void join_and_aggregate(
		int party, std::size_t problem_size, const std::vector<Integer>& input_data, std::vector<Integer>& output_data
	) {
		int c_1 = 1;
		int c_2 = 2;
		int c_3 = 4;
